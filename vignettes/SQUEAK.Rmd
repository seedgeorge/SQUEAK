...
plot_modelled_curves(mixed_model,palette= colors,grouptitle = 'Treatment')
```
...
curvforest = patchwork::wrap_plots(plot_modelled_curves(mixed_model,palette = colors,grouptitle = 'Treatment'),
                                   plot_interaction_forest(mixed_model,palette = colors), 
                                                                      ncol=1)
